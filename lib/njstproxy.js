...
const njsp = require(__dirname + '/../../njssocketpair/lib/NJSSocketPair.js');
const njsx509 = require(__dirname + '/../../njsx509/lib/njsx509.js');
...
const kCAPrivateKeyPassphrase = crypto.randomBytes(16).toString('hex');
